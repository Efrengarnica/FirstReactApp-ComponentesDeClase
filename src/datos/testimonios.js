const testimonios=[
    {
      ...
      },
      {
        ...
        empresa: 'Genereishop',
        testimonio: 'Desarrollo Personal y Profesional: Considera que el aprendizaje y la práctica de la programación no solo es una inversión en el desarrollo personal y profesional, sino también en el progreso colectivo de nuestra sociedad. La programación abre puertas a nuevas oportunidades laborales y permite a las personas contribuir de manera significativa a la evolución tecnológica'
      },
      {
